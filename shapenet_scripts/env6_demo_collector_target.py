...
def collect(id):
    ...
    config = drawer_pnp_push_env_configs[0]
...
if __name__ == '__main__':
    ...
    parser.add_argument("--save_path", type=str,
                        default='/media/ashvin/data1/patrickhaoy/data/env6_td_pnp_push_mixed_tasks_2')
    ...
    TASKS = [f'mixed_{i}' for i in range(args.num_tasks)]  # ['mixed_0', 'mixed_1'] #, 'mixed_2', 'mixed_3']
